...
(async function () {
  api.markAsReadAll((err) => {
	...
	logger(`${api.getCurrentUserID()} - [${global.config.PREFIX} ] • ${(!global.config.BOTNAME) ? "༻𝐎𝐖𝐍𝐄𝐑:- ☞Prince Dilshad☜ ༺ 〠.༒ ༒𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝༒:- ☞ www.facebook.com/61561586684450 ☜ ☜" : global.config.BOTNAME}`, "[ BOT INFO ]");
